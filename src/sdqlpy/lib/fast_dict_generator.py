...
print("module2 is about to be called")
module2 = Extension(
...
print("this is before the setup function is called")  
setup(
...
print("we are just before the deletions")
